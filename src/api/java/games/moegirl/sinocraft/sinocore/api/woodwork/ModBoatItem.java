...
public class ModBoatItem extends BoatItem {
    ...
    public ModBoatItem(Woodwork woodwork, Properties pProperties) {
        super(Boat.Type.OAK, pProperties);
    ...
    public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand hand) {
        ...
        if (hitresult.getType() == HitResult.Type.MISS) {
            ...
            if (hitresult.getType() == HitResult.Type.BLOCK) {
                ModBoat boat = new ModBoat(level, hitresult.getLocation().x, hitresult.getLocation().y, hitresult.getLocation().z);
